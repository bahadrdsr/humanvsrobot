  ...
  return (
    <section className="grid h-full place-items-center p-6">
      <div className="max-w-2xl rounded-[2.5rem] bg-white/78 p-8 text-skyplay-navy shadow-bubble backdrop-blur lg:p-10">
        <p className="text-sm font-semibold uppercase tracking-[0.3em] text-skyplay-teal">Önizleme modu</p>
        <h1 className="mt-3 font-display text-4xl leading-tight">Kimlik doğrulama geçici olarak duraklatıldı; şimdi bilgisayar demosuna odaklanıyoruz.</h1>
        <p className="mt-4 text-base leading-7 text-skyplay-navy/75">
          Düzen, kontroller ve bilgisayar animasyonu önce netleşsin diye sahne şimdilik doğrudan açılıyor.
          Kimlik doğrulama geri geldiğinde bu ekran yeniden gerçek giriş sayfası olabilir.
        </p>
        <button
